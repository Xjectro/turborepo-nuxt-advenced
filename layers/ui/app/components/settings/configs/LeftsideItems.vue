<template>
  ...
  >
    <h2
      class="transition-all mb-4 whitespace-nowrap text-sm font-medium font-inter text-zinc-500 dark:text-zinc-400"
    >
...
const filteredCategories = computed(() => {
  return categories.filter((cat) => !!accountStore._getUser || cat.required);
});
